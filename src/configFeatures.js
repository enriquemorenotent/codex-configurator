...
export const CONFIG_FEATURE_DEFINITIONS = [
  ...
  makeFeatureDefinition('experimental_windows_sandbox', 'Enable experimental Windows sandbox.', 'Turns on a newer Windows sandbox implementation.'),
  ...
  makeFeatureDefinition('unified_exec', 'Use unified execution layer.', 'Route execution commands through the unified tool layer.'),
  makeFeatureDefinition('use_linux_sandbox_bwrap', 'Enable Linux bubblewrap sandbox.', 'Use bwrap for Linux sandbox isolation.'),
  makeFeatureDefinition(
    'web_search',
